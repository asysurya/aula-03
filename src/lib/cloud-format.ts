...
// Peta ekstensi → mimetype kini SATU SUMBER di file-constants.ts (client-safe),
// dipakai bersama oleh serving /api/storage/[key], upload, dan komponen UI.
export { EXT_MIME, mimetypeFromName } from "@/lib/file-constants";
